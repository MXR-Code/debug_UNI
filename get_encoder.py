...
def get_encoder(enc_name='uni2-h',
    ...
    if enc_name in encoder_name_presets.keys():
        enc_name, checkpoint, which_img_norm = encoder_name_presets[enc_name]
